    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(child: Container(
        ...
        child: Column(children: <Widget>[
          Text('¿Qué tipos de crédito hay?', textAlign: TextAlign.center, style: TextStyle(fontSize: 20.0, fontWeight: FontWeight.w600)),
          Divider(),
          ...
          child: Text('¿Interés?', textAlign: TextAlign.center, style: TextStyle(fontSize: 20.0, fontWeight: FontWeight.w600))),
          Divider(),
          Padding(padding: EdgeInsets.fromLTRB(20.0, 10.0, 20.0, 10.0),
          ...
          Padding(padding: EdgeInsets.fromLTRB(20.0, 10.0, 20.0, 10.0),
          child: Text('¡Controla tus deudas!:', textAlign: TextAlign.center, style: TextStyle(fontSize: 24.0, fontWeight: FontWeight.w600))),
          ...
          Padding(padding: EdgeInsets.fromLTRB(20.0, 10.0, 20.0, 10.0),
          child: Text('Pero también puedes Invertir para hacer crecer tus ahorros, claro, en función del riesgo que esto implica.', textAlign: TextAlign.center, style: TextStyle(fontSize: 16.0, fontWeight: FontWeight.w600)))
        ])
    )));
  }
}